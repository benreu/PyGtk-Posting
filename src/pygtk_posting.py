...
class GUI (GObject.GObject):
	...
	__gsignals__ = { 'products_changed': (GObject.SIGNAL_RUN_FIRST, GObject.TYPE_NONE, ()), 'contacts_changed': (GObject.SIGNAL_RUN_FIRST, GObject.TYPE_NONE, ())}
	...
	def __init__(self):
		...
		if os.path.exists ('./src/admin/autoa'):
