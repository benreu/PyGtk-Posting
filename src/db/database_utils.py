...
def check_and_update_version (statusbar):
	...
	if version <= '090':
		...
		cursor.execute("INSERT INTO fiscal_years (name, start_date, end_date, active) VALUES ('2016', '1-1-2016', '2016-12-31', True)")
		cursor.execute("INSERT INTO fiscal_years (name, start_date, end_date, active) VALUES ('2017', '1-1-2017', '2017-12-31', True)")
		cursor.execute("INSERT INTO fiscal_years (name, start_date, end_date, active) VALUES ('2018', '1-1-2018', '2018-12-31', True)")
	...
	if version <= '120':
		progressbar (120)
		cursor.execute("ALTER TABLE product_location ALTER COLUMN product_id SET NOT NULL")
		cursor.execute("ALTER TABLE product_location ADD UNIQUE(product_id, location_id)")
		cursor.execute("ALTER TABLE product_location ALTER COLUMN product_id TYPE bigint")
	if version <= '121':
		progressbar (121)
	...
	if version <= '126':
		progressbar (126)
		cursor.execute("ALTER TABLE contacts DROP COLUMN organization")
		cursor.execute("ALTER TABLE contacts DROP COLUMN price_level")
		cursor.execute("ALTER TABLE contacts DROP COLUMN tax_exempt")
		cursor.execute("ALTER TABLE contacts DROP COLUMN another_role")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN name SET DEFAULT ''")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN ext_name SET DEFAULT ''")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN address SET DEFAULT ''")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN city SET DEFAULT ''")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN state SET DEFAULT ''")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN zip SET DEFAULT ''")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN fax SET DEFAULT ''")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN phone SET DEFAULT ''")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN email SET DEFAULT ''")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN label SET DEFAULT ''")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN tax_number SET DEFAULT ''")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN custom1 SET DEFAULT ''")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN custom2 SET DEFAULT ''")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN custom3 SET DEFAULT ''")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN custom4 SET DEFAULT ''")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN notes SET DEFAULT ''")
		cursor.execute("UPDATE contacts SET checks_payable_to = '' WHERE checks_payable_to IS NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN checks_payable_to SET DEFAULT ''")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN deleted SET DEFAULT False")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN customer SET DEFAULT False")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN vendor SET DEFAULT False")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN employee SET DEFAULT False")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN service_provider SET DEFAULT False")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN name SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN ext_name SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN address SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN city SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN state SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN zip SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN fax SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN phone SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN email SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN label SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN tax_number SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN custom1 SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN custom2 SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN custom3 SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN custom4 SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN notes SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN checks_payable_to SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN deleted SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN customer SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN vendor SET NOT NULL")
		cursor.execute("ALTER TABLE contacts ALTER COLUMN employee SET NOT NULL")
	if version <= '127':
		progressbar (127)
		cursor.execute("ALTER TABLE products DROP COLUMN level_1_price")
		cursor.execute("ALTER TABLE products DROP COLUMN level_2_price")
		cursor.execute("ALTER TABLE products DROP COLUMN level_3_price")
		...
		cursor.execute("ALTER TABLE products ALTER COLUMN purchasable SET DEFAULT False")
		cursor.execute("ALTER TABLE products ALTER COLUMN tax_exemptible SET DEFAULT False")
		cursor.execute("ALTER TABLE products ALTER COLUMN manufactured SET DEFAULT False")
		cursor.execute("ALTER TABLE products ALTER COLUMN weight SET DEFAULT 0.00")
		cursor.execute("ALTER TABLE products ALTER COLUMN tare SET DEFAULT 0.00")
		cursor.execute("ALTER TABLE products ALTER COLUMN ext_name SET DEFAULT ''")
		cursor.execute("ALTER TABLE products ALTER COLUMN stock SET DEFAULT True")
		cursor.execute("ALTER TABLE products ALTER COLUMN expense SET DEFAULT False")
		cursor.execute("ALTER TABLE products ALTER COLUMN job SET DEFAULT False")
		cursor.execute("UPDATE products SET description = '' WHERE description IS NULL")
		cursor.execute("UPDATE products SET ext_name = '' WHERE ext_name IS NULL")
		cursor.execute("UPDATE products SET barcode = id WHERE barcode IS NULL")
		cursor.execute("UPDATE products SET unit = 1 WHERE unit IS NULL")
		cursor.execute("UPDATE products SET sellable = False WHERE sellable IS NULL")
		cursor.execute("UPDATE products SET purchasable = False WHERE purchasable IS NULL")
		cursor.execute("UPDATE products SET tax_exemptible = False WHERE tax_exemptible IS NULL")
		cursor.execute("UPDATE products SET manufactured = False WHERE manufactured IS NULL")
		cursor.execute("UPDATE products SET weight = 0.00 WHERE weight IS NULL")
		cursor.execute("UPDATE products SET tare = 0.00 WHERE tare IS NULL")
		cursor.execute("UPDATE products SET stock = True WHERE stock IS NULL")
		cursor.execute("UPDATE products SET default_expense_account = (SELECT number FROM gl_accounts WHERE expense_account = True LIMIT 1) WHERE default_expense_account IS NULL")
		cursor.execute("ALTER TABLE products ALTER COLUMN name SET NOT NULL")
		cursor.execute("ALTER TABLE products ALTER COLUMN ext_name SET NOT NULL")
		cursor.execute("ALTER TABLE products ALTER COLUMN description SET NOT NULL")
		cursor.execute("ALTER TABLE products ALTER COLUMN barcode SET NOT NULL")
		cursor.execute("ALTER TABLE products ALTER COLUMN unit SET NOT NULL")
		cursor.execute("ALTER TABLE products ALTER COLUMN cost SET NOT NULL")
		cursor.execute("ALTER TABLE products ALTER COLUMN deleted SET NOT NULL")
		cursor.execute("ALTER TABLE products ALTER COLUMN sellable SET NOT NULL")
		cursor.execute("ALTER TABLE products ALTER COLUMN purchasable SET NOT NULL")
		cursor.execute("ALTER TABLE products ALTER COLUMN tax_exemptible SET NOT NULL")
		cursor.execute("ALTER TABLE products ALTER COLUMN manufactured SET NOT NULL")
		cursor.execute("ALTER TABLE products ALTER COLUMN weight SET NOT NULL")
		cursor.execute("ALTER TABLE products ALTER COLUMN tare SET NOT NULL")
		cursor.execute("ALTER TABLE products ALTER COLUMN ext_name SET NOT NULL")
		cursor.execute("ALTER TABLE products ALTER COLUMN stock SET NOT NULL")
		cursor.execute("ALTER TABLE products ALTER COLUMN default_expense_account SET NOT NULL")
	...
	if version <= '131':
		progressbar (131)
		cursor.execute("ALTER TABLE public.settings ADD COLUMN major_version smallint, ADD COLUMN minor_version smallint")
		cursor.execute("UPDATE public.settings SET (major_version, minor_version) = (3, 4)")
		cursor.execute("UPDATE public.tax_rates SET standard = False WHERE standard IS NULL")
		cursor.execute("UPDATE public.products SET min_inventory = 0 WHERE min_inventory IS NULL")
		cursor.execute("ALTER TABLE public.products ALTER COLUMN min_inventory SET DEFAULT 0")
		cursor.execute("UPDATE public.products SET reorder_qty = 0 WHERE reorder_qty IS NULL")
		cursor.execute("ALTER TABLE public.products ALTER COLUMN reorder_qty SET DEFAULT 0")
		cursor.execute("UPDATE public.products SET inventory_enabled = False WHERE inventory_enabled IS NULL")
		cursor.execute("ALTER TABLE public.payments_incoming ALTER COLUMN check_payment SET DEFAULT False")
		cursor.execute("UPDATE public.payments_incoming SET check_payment = False WHERE check_payment IS NULL")
		cursor.execute("UPDATE public.incoming_invoices SET canceled = False WHERE canceled IS NULL")
		cursor.execute("UPDATE public.invoices SET total = 0.00 WHERE total IS NULL;")
		cursor.execute("UPDATE public.invoices SET amount_due = total WHERE amount_due IS NULL")
		cursor.execute("UPDATE public.invoice_items SET imported = False WHERE imported IS NULL")
		cursor.execute("UPDATE contact_individuals SET website = ''")
		cursor.execute("DROP TABLE public.document_column_settings")
		cursor.execute("UPDATE public.documents SET printed = False WHERE printed IS NULL;")
		cursor.execute("UPDATE public.document_lines SET type_1 = False WHERE type_1 IS NULL;")
		cursor.execute("UPDATE public.document_lines SET type_2 = '' WHERE type_2 IS NULL;")
		cursor.execute("UPDATE public.document_lines SET type_3 = '' WHERE type_3 IS NULL;")
		cursor.execute("UPDATE public.document_lines SET type_4 = '' WHERE type_4 IS NULL;")
		cursor.execute("ALTER TABLE public.documents ALTER COLUMN printed SET DEFAULT False")
		cursor.execute("UPDATE public.incoming_invoices SET paid = False WHERE paid IS NULL;")
		cursor.execute("UPDATE public.purchase_orders SET printed = False WHERE printed IS NULL")
		cursor.execute("UPDATE public.purchase_orders SET closed = False WHERE closed IS NULL")
		cursor.execute("UPDATE public.purchase_orders SET invoiced = False WHERE invoiced IS NULL")
		cursor.execute("UPDATE public.resources SET to_do = False WHERE to_do IS NULL")
		cursor.execute("UPDATE public.resources SET date_created = dated_for WHERE date_created IS NULL")
